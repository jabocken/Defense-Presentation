...
\begin{frame}{Modeling Exceptional \Glsfmtshort{abi} Calls}{Specification source: \citeurl{cxxEhAbi}}
...
\begin{frame}{How to check abstract semantics versus concrete?}
  ...
  \includegraphics[width=.15\textwidth]{intel_bx80619i73970x_core_i7_extreme_i7_3970x_908772}
  \begin{equation}
...
\begin{frame}{Challenges}
  \begin{outline}
    \1 Implementation quirks
      \2 Concrete implementation of \inlineasm{__cxa_begin_catch} takes absolute value of negative handler counts supplied to it before incrementing that value
      \2 \inlineasm{__cxa_rethrow} decreases $\handlerCount$ magnitude by one, then inverts sign; if the magnitude is 0, it is unchanged
